...
from maid_runner.validators.manifest_validator import (
    ...
    validate_with_ast,  # noqa: F401 - Re-exported for test compatibility
)
from maid_runner.validators.semantic_validator import (
    validate_manifest_semantics,  # noqa: F401 - Re-exported for test compatibility
    validate_supersession,  # noqa: F401 - Re-exported for test compatibility
)
...
from . import _text_mode_validation
...
def run_validation(
    ...
    # Text output mode: run standard validation with text output
    _text_mode_validation.run_text_mode_validation(
        manifest_path,
        validation_mode,
        use_manifest_chain,
        quiet,
